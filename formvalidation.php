...
<body>
<!--script php untuk mendeklarasikakn variabel-->
<?php 
$error_nama = ""; 
$error_email = ""; 
$error_web = ""; 
...
$pesan = ""; 
$telp = "";
//menampilkan pesan error jika data yang diinput salah atau kosong
...
<!--mencetak data yang telah diinput-->
<?php 
